package com.pujianto131.myservice;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        private Button btnStartIntenService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnStartIntenService = (Button)findViewById(R.id.btn_start_inten_service);
        btnStartIntenService.setOnClickListener(this);
    }
